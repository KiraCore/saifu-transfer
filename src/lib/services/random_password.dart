...
class RandomPasswordGenerator {
  ...
  String randomPassword({bool letters = true, bool uppercase = false, bool numbers = false, bool specialChar = false, double passwordLength = 8}) {
    if (letters == false && uppercase == false && specialChar == false && numbers == false) {
      letters = true;
    }
    // Removed similar letters, numbers and symbols
    String _lowerCaseLetters = "abcdefghjkmnpqrstuvwxyz";
    String _upperCaseLetters = _lowerCaseLetters.toUpperCase();
    String _numbers = "23456789";
    String _special = "@#=+!£\$%&?[](){}";
